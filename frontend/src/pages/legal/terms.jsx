        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Welcome to Zillionaires. By accessing and using our platform, you agree to be bound by these Terms of Service.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              <li>"Platform" refers to the Zillionaires website and services</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600">
              ...
              <br />
              Email: support@zillionaires.com
              <br />
